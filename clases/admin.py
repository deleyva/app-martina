...
class SubjectAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Presentación", {"fields": ("icon", "color")}),
...
class GroupInvitationAdmin(admin.ModelAdmin):
    ...
    list_filter = ("is_active", "group", "created_at", "expires_at")
...
class ClassSessionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("title", "group", "teacher", "date")}),
        ("Contenido", {"fields": ("notes", "metadata")}),
        ("Información", {"fields": ("created_at", "updated_at")}),
    )
